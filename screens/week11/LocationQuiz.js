...
import UserMark from "../../components/week11/UserMark";
...
export default function LocationQuiz() {
  ...
  return (
    <View style={{ flex: 1, flexDirection : 'column' ,backgroundColor : "#BEBEBE"}}>
            ...
            <View style={{flexDirection : 'row', height : 70 , backgroundColor : "#FF9933"}}>      
            ...
            <View style={{ flex: 1 }}>
                <UserMark location={location } setLocation={setLocation}/>
            </View>
    </View>
  );
}
